...
namespace BugTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyId,ProjectId,InvitorId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,Message,IsValid,InviteDate,JoinDate,CompanyToken")] Invite invite)
        {
            if (id != invite.Id)
            {
                return NotFound();
