...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notifications.Include(n => n.NotificationType).Include(n => n.Projects).Include(n => n.Recipient).Include(n => n.Sender).Include(n => n.Tickets);
