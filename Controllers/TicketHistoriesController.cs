...
namespace BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,PropertyName,Description,OldValue,NewValue,UserId,Created")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,PropertyName,Description,OldValue,NewValue,UserId,Created")] TicketHistory ticketHistory)
        {
